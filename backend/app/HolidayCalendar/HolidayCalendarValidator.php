...
class HolidayCalendarValidator
{
    ...
    public function validateUpdate(array $payload): void
    {
        ...
        if (array_key_exists('holiday_name', $payload) && trim((string) $payload['holiday_name']) === '') {
            $errors['holiday_name'][] = 'Holiday calendar name cannot be empty.';
        }
    ...
    private function validateRequired(array $payload): array
    {
        ...
        foreach (['holiday_name', 'academic_session_id'] as $field) {
