    ...
    public function create(CreateAcademicClassRequest $request): AcademicClass
    {
        ...
        try {
            ...
            if ($this->auditLogger instanceof AuditLoggerInterface) {
                $this->auditLogger->log('CREATE', 'academic_class', $result->id(), null, $payload);
            }
    ...
    public function update(UpdateAcademicClassRequest $request): ?AcademicClass
    {
        ...
        try {
            ...
            if ($result !== null && $this->auditLogger instanceof AuditLoggerInterface) {
                $this->auditLogger->log('UPDATE', 'academic_class', $request->id(), $this->auditLogger->entityToArray($old), $payload);
            }
    ...
    public function delete(int $id): bool
    {
        ...
        try {
            ...
            if ($result && $this->auditLogger instanceof AuditLoggerInterface) {
                $this->auditLogger->log('DELETE', 'academic_class', $id, $this->auditLogger->entityToArray($old));
            }
