...
class SectionValidator
{
    ...
    public function validateUpdate(array $payload): void
    {
        ...
        if (array_key_exists('section_name', $payload) && trim((string) $payload['section_name']) === '') {
            $errors['section_name'][] = 'Section name cannot be empty.';
        }
    ...
    private function validateRequired(array $payload): array
    {
        ...
        foreach (['section_name', 'class_id'] as $field) {
